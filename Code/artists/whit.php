...
<div id="myModall" class="modall">
 ...
 <div class="text">Whitney Houston</div>
    <div id="img" style="background: url('wh.jpg') no-repeat center;float:left;background-size: contain;"></div>
<div class="play">
<button id="0">1&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspI Look To You</button><br/>
<button id="1">2&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspI Have Nothing</button><br/>
<button id="2">3&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspHow Will I Know</button><br/>
<button id="3">4&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspWhen You Believe</button><br/>
<button id="4">5&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspI Will Always Love You</button><br/>
<button id="5">6&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSaving All My Love For You</button><br/>
<button id="6">7&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspI'm Every Woman</button><br/>
<button id="7">8&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspOne Moment In Time</button><br/>
<button id="8">9&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspExhale</button><br/>
<button id="9">10&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspHeartbreak Hotel</button><br/>
</div>
</body>
<script>
var bg='wh';
