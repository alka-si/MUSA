...
<div id="myModall" class="modall">
 ...
 <div class="text">Sam Smith</div>
    <div id="img" style="background: url('ss.jpg') no-repeat center;float:left;background-size: contain;"></div>
<div class="play">
<button id="0">1&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspStay With Me</button><br/>
<button id="1">2&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspToo Good At Goodbyes</button><br/>
<button id="2">3&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspLay Me Down</button><br/>
<button id="3">4&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspBurning</button><br/>
<button id="4">5&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspWriting's On The Wall</button><br/>
<button id="5">6&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspOne Last Song</button><br/>
<button id="6">7&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspOmen</button><br/>
<button id="7">8&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDrowning Shadows</button><br/>
<button id="8">9&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspMoney On My Mind</button><br/>
<button id="9">10&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspLike I Can</button><br/>
