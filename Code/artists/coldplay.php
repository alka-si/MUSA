...
<div id="myModall" class="modall">
 ...
 <div class="text">Coldplay</div>
    <div id="img" style="background: url('cp.jpg') no-repeat center;float:left;"></div>
<div class="play">
<button id="0">1&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspFix You</button><br/>
<button id="1">2&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspThe Scientist</button><br/>
<button id="2">3&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspYellow</button><br/>
<button id="3">4&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspParadise</button><br/>
<button id="4">5&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspViva la Vida</button><br/>
<button id="5">6&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspEverglow</button><br/>
<button id="6">7&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspA Sky Full of Stars</button><br/>
<button id="7">8&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspHymm for the Weekend</button><br/>
<button id="8">9&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSomething Just Like This
</button><br/>
<button id="9">10&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspEvery Teardrop is a Waterfall</button><br/>
</div>
</body>
<script>
var bg='cp';
