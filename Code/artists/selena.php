...
<body>
 <div class="topnav" id="nav">
		...
		<?php if($_SESSION["name"]!=""){ echo "<a class='right' style='float:right;' href='front1.php'>logout</a>";}
         else{
			 echo "<a class='right' style='float:left;' href='front1.php'>login</a>";
		 }		?>
...
<div id="myModall" class="modall">
 ...
 <div class="text">Selena Gomez</div>
    <div id="img" style="background: url('sg.jpg') no-repeat center;float:left;"></div>
<div class="play">
<button id="0">1&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspIt Ain't Me</button><br/>
<button id="1">2&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspPerfect</button><br/>
<button id="2">3&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspThe Heart Wants What it Wants</button><br/>
<button id="3">4&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspLove You Like a Love Song</button><br/>
<button id="4">5&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspHit The Lights</button><br/>
<button id="5">6&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSend it On</button><br/>
<button id="6">7&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspFetish</button><br/>
<button id="7">8&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCom and Get It</button><br/>
<button id="8">9&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspBad Liar</button><br/>
<button id="9">10&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspWho Says</button><br/>
